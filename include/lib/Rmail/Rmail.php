    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        $helo = 'localhost';
        $this->smtp_params['host'] = EMAIL_SMTP_SERVER;
        $this->smtp_params['port'] = EMAIL_SMTP_PORT;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = EMAIL_SMTP_AUTH;
        $this->smtp_params['user'] = EMAIL_SMTP_USER;
        $this->smtp_params['pass'] = EMAIL_SMTP_PASS;
