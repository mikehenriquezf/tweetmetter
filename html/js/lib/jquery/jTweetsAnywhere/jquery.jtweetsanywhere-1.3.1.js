...
(function($)
{
	...
	defaultMainDecorator = function(options)
	{
		...
		if (options._tweetBoxElement)
		{
			...
			options._baseElement.append("<div class='hd'><h5>PARTICIPA: <span>#ElGranDebate2012</span></h5></div><hr />");
		}
	...
	defaultTweetFeedControlsDecorator = function(options)
	{
		...
		return '<div class="jta-tweet-list-controls"><hr />' + html + '</div>';
	};
	...
	addHovercards = function(options)
	{
		if (isAnywherePresent())
		{
			...
			if(!options.scrollCreated){
				$("ul.jta-tweet-list").wrap("<div id=\"tweetListToScroll\" />")
				$('#tweetListToScroll').jScrollPane({ verticalDragMaxHeight: 100, autoReinitialise: true });
			}
		}
	};
